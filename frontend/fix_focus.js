...
files.forEach((f) => {
	...
	content = content.replace(
		/focus:border-primario focus:outline-none focus:ring-1 focus:ring-primario/g,
		'focus:border-primario focus:outline-none'
	);

	// Now replace all focus:border-primario focus:outline-none with the full string
	const newContent = content.replace(
		/focus:border-primario focus:outline-none/g,
		'focus:border-primario focus:outline-none focus:ring-1 focus:ring-primario'
	);
